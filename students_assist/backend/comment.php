...
$statement = $db->prepare('INSERT INTO comments_table
...
$update2= $db->prepare('UPDATE posts_table set total_comments =:total_comments where id=:id');
...
$comment_result = $db->prepare('SELECT COUNT(*) AS cntcomment FROM comments_table WHERE postid=:postid');
